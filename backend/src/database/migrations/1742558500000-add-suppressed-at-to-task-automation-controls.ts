...
export class AddSuppressedAtToTaskAutomationControls1742558500000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    if (hasColumn) {
      await queryRunner.dropColumn('task_automation_controls', 'suppressed_at');
    }
  }
}
