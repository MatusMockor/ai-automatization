          ...
          return (
            <div key={col.prefix} className="flex w-[280px] shrink-0 flex-col">
              <div className="mb-3 flex items-center gap-2">
                <span
                  className={`rounded px-1.5 py-0.5 text-[11px] font-semibold uppercase tracking-wide ${cfg.activeColor}`}
                >
                  {col.prefix}
                </span>
                ...
                <div className="space-y-2 pr-1">
                  {col.tasks.map((task) => (
                    <Card
                      ...
                      tabIndex={0}
                      role="button"
                      className="cursor-pointer border-border bg-card transition-all hover:border-foreground/15 hover:bg-foreground/[0.03] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
                    ...
                    >
                      <CardContent className="p-3.5">
                        ...
                        <ActionButtons
                          size="sm"
                          onAction={(action) => console.log(action, task.id)}
                        />
                      </CardContent>
                    </Card>
                  ))}
